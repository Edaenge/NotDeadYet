...
private:
	...
	iImage* mHoveredImage;
	iImage* mPressedImage;
...
public:
	...
	void SetActivePos(Vector2 pos){ this->mActiveX = pos.x; this->mActiveY = pos.y; }
	/*! Saves the pos of active pos in parameters*/
	Vector2 GetActivePos(){ return Vector2(this->mActiveX, this->mActiveY); }
