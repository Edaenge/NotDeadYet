...
void FootStepClient::PlaceFootStep( Actor* actor )
{
	...
	else if ( actor->GetModel() == "media/models/bear_anims.fbx" )
	{
		unsigned int lastFoot = zLastFoot[actor];
		...
		if ( !lastFoot )
		{
			name = "media/models/bear_print_r.png";
			printPos += rightDir * 0.2f;
		}
		else
		{
			name = "media/models/bear_print_l.png";
			printPos += Vector2(-rightDir.x, -rightDir.y) * 0.2f;
		}
	...
	else if ( actor->GetModel() == "media/models/deer_anims.fbx" )
	{
		unsigned int lastFoot = zLastFoot[actor];
		...
		if ( !lastFoot )
		{
			name = "media/models/deer_print_r.png";
			printPos += rightDir * 0.2f;
		}
		else
		{
			name = "media/models/deer_print_l.png";
			printPos += Vector2(-rightDir.x, -rightDir.y) * 0.2f;
		}
