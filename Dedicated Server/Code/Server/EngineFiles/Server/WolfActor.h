...
public:
	...
	WolfActor(const Vector3& startPos, bool genID = true, bool isPlayerControlled = false);
	WolfActor(const Vector3& startPos, const Vector4& rot, bool genID = true, bool isPlayerControlled = false);
	virtual ~WolfActor();
