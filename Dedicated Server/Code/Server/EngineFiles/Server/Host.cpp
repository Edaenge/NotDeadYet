...
void Host::SendStaticActorUpdates()
{
	...
	std::vector<FoodObject*> stf = actorHandler->GetFoods();
	...
	std::vector<WeaponObject*> stw = actorHandler->GetWeapons();
	...
	std::vector<ContainerObject*> stc = actorHandler->GetContainers();
